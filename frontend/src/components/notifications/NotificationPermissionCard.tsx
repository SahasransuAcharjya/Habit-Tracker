  ...
  return (
    <div className="rounded-2xl border border-border bg-card p-5 shadow-lg">
      <div className="flex items-start justify-between gap-3">
        <div>
          <p className="text-xs uppercase tracking-[0.2em] text-primary-400">Notifications</p>
          <h3 className="mt-2 text-lg font-semibold text-foreground">Enable reminders</h3>
          <p className="mt-2 text-sm text-muted-foreground">
            Allow push notifications so the app can remind you about pending tasks.
          </p>
        </div>

        <div className="rounded-full bg-primary-500/10 px-3 py-1 text-xs font-medium text-primary-600">
          Push
        </div>
      </div>
        ...
        <div
          className={`mt-4 rounded-xl px-4 py-3 text-sm ${
            statusType === "success"
              ...
              : "border border-primary-800 bg-primary-950/40 text-primary-300"
          }`}
        >
          {status}
        </div>
